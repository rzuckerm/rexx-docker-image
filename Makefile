REXX_VERSION := $(shell cat REXX_VERSION)
REXX_DEPS := $(wildcard REXX_*)
DOCKER_TAG_PREFIX := rzuckerm/rexx:$(REXX_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(REXX_DEPS)
